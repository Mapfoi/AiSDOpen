...
begin
  ...
  Writeln('  ', Char($04), ' - путь к выходу');
  Writeln('  S - лестницы на 3 этаже (ведут на 2 этаж)');
  Writeln('  E - лифты на 2 этаже (ведут на 1 этаж)');
  Writeln('  P - выход с 1 этажа');
  Writeln('  J - выходы из лифтов');
  Writeln('  С - выходы с лестниц');
  Writeln('  X - ваше текущее местоположение');
   Writeln;
  Writeln('  Лестницы и лифты могут привести к случайным выходам! ');
  Writeln;
